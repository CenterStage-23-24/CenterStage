...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 14.8; //tuned
    public static double FORWARD_OFFSET = 6.68; // tuned
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        ...
        leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "LSR")); //EH port 3
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "RB")); //CH port 3
        frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "frontEncoder")); //EH port 0

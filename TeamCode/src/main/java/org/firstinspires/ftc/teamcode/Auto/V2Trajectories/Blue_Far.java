...
public class Blue_Far extends LinearOpMode {
    ...
    public static double purpleLeftX = -40.0;
    public static double purpleLeftY = 32.0;
    public static double purpleLeftAngle = 0; //degree value of angle

    //CENTER
    public static double yellowCenterX = 50.0;
    public static double yellowCenterY = 38.0;
    public static double purpleCenterX = -48.0;
    public static double purpleCenterY = 24.0;
    ...
    public static double purpleRightX = -60;
     ...
     */
    private double startX = -36.0; //starting X position
    ...
    private boolean backDropExtend = false;
    private boolean spikeExtend = false;
    ...
    public void runOpMode() {
        ...
        TrajectorySequence trajectory = drive.trajectorySequenceBuilder(new Pose2d(startX, startY, Math.toRadians(startHeading)))
                ...
                .splineToLinearHeading(new Pose2d(purplePixelX + purplePixelXOffset, purplePixelY + purplePixelYOffset, Math.toRadians(0)), Math.toRadians(purplePixelAngle))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    gripper.releaseLeft();
                })
                .waitSeconds(0.5)
                ...
                .waitSeconds(2)
                .lineToLinearHeading(new Pose2d(purplePixelX + purplePixelXOffset, 12, Math.toRadians(0)))
                ...
                .waitSeconds(2)
                .splineToConstantHeading(new Vector2d(yellowPixelX + yellowPixelXOffset, yellowPixelY + yellowPixelYOffset), Math.toRadians(0))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    gripper.releaseRight();
                })
                .waitSeconds(0.5)
                .lineToConstantHeading(new Vector2d(45, yellowPixelY+yellowPixelYOffset))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    while (!transferController.retract()) {
                        slides.pid(true);
                        arm.updatePos();

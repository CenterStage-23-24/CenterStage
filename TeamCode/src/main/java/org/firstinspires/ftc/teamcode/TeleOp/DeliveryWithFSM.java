/*
This is a reference OpMode that contains a potential integration of all delivery mechanisms with our
Cycle FSM - just one idea
Use only as a REFERENCE when integrating delivery with FSMs on TransferIntegration Branch
 */
...
public class DeliveryWithFSM {
    ...
    public DeliveryWithFSM(HWMap hwMap, GamepadEx gamepad, Telemetry telemetry, FieldCentricDrive fieldCentricDrive) {
